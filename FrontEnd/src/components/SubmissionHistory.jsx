    ...
    const fetchSubmissions = async () => {
      try {
        ...
        if (Array.isArray(data)) {
          ...
          // sometimes payload may wrap in object
              ...
              <tbody>
                {submissions.map((sub, index) => (
                  <tr key={sub._id}>
                    ...
                    <td className="font-mono">{sub.runtime != null ? `${sub.runtime}sec` : 'N/A'}</td>
            ...
            <div className="mb-4">
              <div className="flex flex-wrap gap-2 mb-2">
                ...
                <span className="badge badge-outline">
                  Runtime: {selectedSubmission.runtime != null ? `${selectedSubmission.runtime}s` : 'N/A'}
                </span>
                <span className="badge badge-outline">
                  Memory: {formatMemory(selectedSubmission.memory || 0)}
                </span>
                <span className="badge badge-outline">
